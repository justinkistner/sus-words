-- Fix realtime publication for rooms table (corrected syntax)
...
-- Note: These will error if tables aren't in publication, but that's okay
ALTER PUBLICATION supabase_realtime DROP TABLE rooms;
ALTER PUBLICATION supabase_realtime DROP TABLE room_players;
ALTER PUBLICATION supabase_realtime DROP TABLE clues;
ALTER PUBLICATION supabase_realtime DROP TABLE votes;
ALTER PUBLICATION supabase_realtime DROP TABLE game_rounds;
